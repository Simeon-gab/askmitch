...
**Production URL:** `https://askmitch.ng`
*(bookmark it once on every staff phone — nobody should type it twice; the QR in `assets/` points here — print from those files only)*
